...
def check_and_pull_model():
    ...
    print(f"[ML Engine] Checking Ollama connection and model '{model_name}'...")
    ...
    try:
        ...
        if e.status_code == 404:
            ...
            print(f"[ML Engine] Starting automatic download (this may take a few minutes)...")
            ollama.pull(model_name)
            print("[ML Engine] Model downloaded successfully.")
        else:
